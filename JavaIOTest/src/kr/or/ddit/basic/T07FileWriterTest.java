...
public class T07FileWriterTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * // 사용자가 입력한 내용을 그대로 파일로 저장하기 char c1= 'A'; // 문자를 직접 입력 char c2 = 65; //
		 * 10진수를 지정 char c3 = '\u0041'; // 16진수로 지정(유니코드)
		 * 
		 * char c4 = '가'; // 문자 char c6 = 44032; // 10진수 char c5 = '\uAC00'; //
		 * 16진수(유니코드)
		 * 
		...
		try {
			...
			// 콘솔에서 입력할 때 입력의 끝 표시는 Ctrl + Z 르면 된다
